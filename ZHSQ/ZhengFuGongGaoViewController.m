//
//  ZhengFuGongGaoViewController.m
//  ZHSQ
//
...
#import "ZhengFuGongGaoViewController.h"
...
@interface ZhengFuGongGaoViewController ()
{
...
@implementation ZhengFuGongGaoViewController
          ...
          //  }];
           ...
           // NSLog(@"&&&&&&&&&&%@",arr);
            if ([arr count]==0)
            {
                ...
                __block ZhengFuGongGaoViewController *bSelf=self;
                ...
                if ([arr count]<10)
                {
                    gonggao =[[zhengfugonggao alloc]init];
                    gonggao.city_id=@"101";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ((imageurl.length>0&&![imageurl isEqualToString:@""])&&(imageurl!=nil)&&(data.length>0))
    {
        ...
        //imagea.hidden = NO;
        [imageView setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",imageurl]]
    ...
    usingActivityIndicatorStyle:UIActivityIndicatorViewStyleGray];
        ...
        UILabel *name=[[UILabel alloc]initWithFrame:CGRectMake(50, 3, 300, 20)];
        ...
        UILabel *publish_department=[[UILabel alloc]initWithFrame:CGRectMake(50, 30, 125, 20)];
...
{
    ZhengFuGongGaoDictionary=_fakeData[indexPath.row];
    ZhengFuGongGaoXiangQingViewController *xiangqing=[[ZhengFuGongGaoXiangQingViewController alloc]init];
