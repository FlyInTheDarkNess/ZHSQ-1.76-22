//
//  ShiZhengXinWenXiangQingViewController.m
//  ZHSQ
//
...
#import "ShiZhengXinWenXiangQingViewController.h"
extern NSDictionary *Dictionary;
@interface ShiZhengXinWenXiangQingViewController ()

@end

@implementation ShiZhengXinWenXiangQingViewController
...
- (void)viewDidLoad
{
    ...
    label1.text=[Dictionary objectForKey:@"title"];
    ...
    if (![[Dictionary objectForKey:@"video_url"] isEqualToString:@""])
    {
        UIImage *img = [UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:[Dictionary objectForKey:@"video_pic_thumbs"]]]];
        imageview2=[[UIImageView alloc]initWithImage:img];
        imageview2.frame=CGRectMake(0, 40, 320, 200);
        [myscrollview addSubview:imageview2];

        
        video_url=[Dictionary objectForKey:@"video_url"];
    ...
    label2.text=[Dictionary objectForKey:@"createdate"];
    ...
    label3.text=[Dictionary objectForKey:@"source"];
    ...
    NSString * tstring =[Dictionary objectForKey:@"content"];
