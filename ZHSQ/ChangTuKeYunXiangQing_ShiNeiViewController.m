//
//  ChangTuKeYunXiangQing_ShiNeiViewController.m
//  ZHSQ
//
...
@interface ChangTuKeYunXiangQing_ShiNeiViewController ()

@end

@implementation ChangTuKeYunXiangQing_ShiNeiViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UILabel *zhan=[[UILabel alloc]initWithFrame:CGRectMake(10, 25, 80, 20)];
    ...
    UILabel *label_beijing=[[UILabel alloc]initWithFrame:CGRectMake(90, 5, 220, 60)];
    ...
    juli.font=[UIFont systemFontOfSize:12];
