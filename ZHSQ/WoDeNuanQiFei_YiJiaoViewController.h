//
//  WoDeNuanQiFei_YiJiaoViewController.h
//  ZHSQ
//
...
@interface WoDeNuanQiFei_YiJiaoViewController : UIViewController
...
@property (weak, nonatomic) IBOutlet UILabel *label_xufeiriqi;
@property (weak, nonatomic) IBOutlet UILabel *label_xufeiren;
