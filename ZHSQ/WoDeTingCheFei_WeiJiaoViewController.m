//
//  WoDeTingCheFei_WeiJiaoViewController.m
//  ZHSQ
//
...
NSString *string_Ip;
@interface WoDeTingCheFei_WeiJiaoViewController ()

@end

@implementation WoDeTingCheFei_WeiJiaoViewController
...
- (void)viewDidLoad
{
    @try
    {
        ...
        label_jianzhumianji.text=[WYF_Dictionary objectForKey:@"car_site"];
        label_danjia.text=[WYF_Dictionary objectForKey:@"car_no"];
