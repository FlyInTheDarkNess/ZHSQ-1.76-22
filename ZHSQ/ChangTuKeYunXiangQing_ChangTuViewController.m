//
//  ChangTuKeYunXiangQing_ChangTuViewController.m
//  ZHSQ
//
...
@interface ChangTuKeYunXiangQing_ChangTuViewController ()

@end

@implementation ChangTuKeYunXiangQing_ChangTuViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    juli.text=[NSString stringWithFormat:@" 距离：%@",[arr_ChangTuKeYun[indexPath.row] objectAtIndex:1]];
    ...
    piaojia.text=[NSString stringWithFormat:@" 票价：%@",[arr_ChangTuKeYun[indexPath.row] objectAtIndex:2]];
