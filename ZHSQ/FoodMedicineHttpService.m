...
#import "FoodMedicineHttpRequest.h"
@interface FoodMedicineHttpService()
{
    FoodMedicineHttpRequest *httpRequest;
}
@end

@implementation FoodMedicineHttpService
-(void)beginQuery
{
    httpRequest = [[FoodMedicineHttpRequest alloc]initWithURL:self.strUrl setRequestDict:self.requestDict forRequestMethod:@"POST" isSynRequest:NO observer:self];
