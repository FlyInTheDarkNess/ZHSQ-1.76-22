...
@interface FoodMedicineHttpRequest()
{
...
@implementation FoodMedicineHttpRequest
//联网失败
...
-(void)requestFinished:(ASIHTTPRequest *)request
{
    ...
    if(!error)
    {
        ...
        self.result = data;
        //  社区选择接口
        if ([self.urlStr_ isEqualToString:ZiXunXinXi_m38_01])
        {
            self.errorCode = 1;
        }
        //  城市选择接口
        ...
        //  公积金接口
        else if ([self.urlStr_ isEqualToString:GongJiJin_m1_04])
        {
            self.errorCode = 3;
        }
