...
extern int IsFiirst;
@interface CheLiangXinXiViewController ()

@end

@implementation CheLiangXinXiViewController
@synthesize label_beijing,label_chepaohao,btn_qicheleixing,textfield_shibiema,label_zhuzhi;
...
- (void)viewDidLoad
{
    ...
    label_chepaohao.text=[QiChe_Dictionary objectForKey:@"car_code"];
    textfield_shibiema.text=[QiChe_Dictionary objectForKey:@"identification_code"];
    ...
    btn_qicheleixing.layer.borderWidth=1;
    btn_qicheleixing.layer.masksToBounds=YES;
    btn_qicheleixing.layer.cornerRadius=6;
    btn_qicheleixing.layer.borderColor=[[UIColor grayColor] CGColor];
    [btn_qicheleixing setTitle:[QiChe_Dictionary objectForKey:@"plate_name"] forState:UIControlStateNormal];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [btn_qicheleixing setTitle:arr1[indexPath.row] forState:UIControlStateNormal];
...
- (IBAction)btn_wancheng:(id)sender
{
    ...
    customer.platet_num =label_chepaohao.text;
    ...
    [HttpPostExecutor postExecuteWithUrlStr:CheLiangXinXi_m1_14 Paramters:Str FinishCallbackBlock:^(NSString *result)
     {
         ...
         if (intb==1000)
         {
             GeRenZhongXinViewController *zhongxin=[[GeRenZhongXinViewController alloc]init];
