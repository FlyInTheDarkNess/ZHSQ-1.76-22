...
-(void)dataInit
{
    NSString *str1=@"{\"session\":\"\",\"city_id\":\"101\",\"area_id\":\"\",\"agency_id\":\"\",\"community_id\":\"\",\"quarter_id\":\"\",\"article_type_id\":\"4\"}";
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Dictionary=newsArr[indexPath.row];
    ShiZhengXinWenXiangQingViewController *xiangqing=[[ShiZhengXinWenXiangQingViewController alloc]init];
