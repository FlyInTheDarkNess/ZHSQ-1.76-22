...
#import "WoDeWuYeFei_YiJiaoViewController.h"
...
@interface WoDeWuYeFeiViewController ()

@end

@implementation WoDeWuYeFeiViewController
...
- (void)viewDidLoad
{
    @try
    {
        ...
        NSLog(@"%@",str1);
      //  NSString *str1=@"{\"session\":\"251|20140928173007\",\"type\":\"2\",\"flag\":\"2\",\"date_start\":\"\",\"date_end\":\"\"}";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        if ([tableView isEqual:tableview_lishizhangdan])
        {
            ...
            label3.textColor=[UIColor colorWithRed:135/255.0 green:206/255.0 blue:235/255.0 alpha:1];
            ...
            label7.textColor=[UIColor colorWithRed:72/255.0 green:185/255.0 blue:215/255.0 alpha:1];
            label7.backgroundColor=[UIColor colorWithRed:220/255.0 green:220/255.0 blue:220/255.0 alpha:1];
        ...
        if ([tableView isEqual:tableview_weijiaofei])
        {
            ...
            label9.font=[UIFont systemFontOfSize:12];
            label9.textColor=[UIColor colorWithRed:72/255.0 green:185/255.0 blue:215/255.0 alpha:1];            label9.backgroundColor=[UIColor colorWithRed:220/255.0 green:220/255.0 blue:220/255.0 alpha:1];
            [cell addSubview:label9];
            UILabel *label10=[[UILabel alloc]initWithFrame:CGRectMake(0, 119, 320, 1)];
            label10.backgroundColor=[UIColor grayColor];
            [cell addSubview:label10];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if ([tableView isEqual:tableview_lishizhangdan])
    {
        ...
        WoDeWuYeFei_YiJiaoViewController *xiangqing=[[WoDeWuYeFei_YiJiaoViewController alloc]init];
    ...
    else
    {
        ...
        WoDeWuYeFei_WeiJiaoViewController *xiangqing=[[WoDeWuYeFei_WeiJiaoViewController alloc]init];
        [self presentViewController:xiangqing animated:NO completion:nil];
