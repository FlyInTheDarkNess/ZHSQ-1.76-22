//
//  FangChanYeWuXiangQingViewController.m
//  ZHSQ
//
...
@interface FangChanYeWuXiangQingViewController ()

@end

@implementation FangChanYeWuXiangQingViewController
...
- (void)viewDidLoad
{
    ...
    NSString * string;
    string =[FangChanYeWuDictionary objectForKey:@"title"];
    ...
    label_publish_department.text=[FangChanYeWuDictionary objectForKey:@"summary"];
    ...
    NSArray *arr=[NSArray arrayWithArray:[FangChanYeWuDictionary objectForKey:@"pic"]];
    ...
    label_time.text=[FangChanYeWuDictionary objectForKey:@"article_date"];
    label_time.font=[UIFont systemFontOfSize:12];
    label_time.textColor=[UIColor grayColor];
    [myscrollview addSubview:label_time];
    
    hengxian=[[UILabel alloc]initWithFrame:CGRectMake(0, actualsize.height+15, 320, 1)];
    ...
    NSString * tstring;
    tstring =[FangChanYeWuDictionary objectForKey:@"content"];
    ...
    //添加图片标题，确定图片标题位置
    label_content.frame =CGRectMake(10,actualsize.height+40+gao,320, ctualsize.height);//最终的坐标位置
