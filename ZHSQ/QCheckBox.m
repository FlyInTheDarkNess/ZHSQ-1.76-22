...
- (id)initWithDelegate:(id)delegate {
    ...
    if (self) {
        ...
        [self setImage:[UIImage imageNamed:@"payeco_plugin_checkbox_checked.png"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"payeco_plugin_checkbox_normal.png"] forState:UIControlStateSelected];
