...
#import "WoDeNuanQiFei_WeiJiaoViewController.h"
#import "WoDeNuanQiFei_YiJiaoViewController.h"
...
@interface WoDeNuanQiFeiViewController ()

@end

@implementation WoDeNuanQiFeiViewController
    ...
    @try
    {
        ...
        [HttpPostExecutor postExecuteWithUrlStr:KuaiJieJiaoFeiZhuJian_m30_01 Paramters:Str FinishCallbackBlock:^(NSString *result){
            ...
            if (intb==1000)
            {
                ...
                NSString *Str;
                Str=[str2 stringByAppendingString:str_jiami];
                [HttpPostExecutor postExecuteWithUrlStr:NuanQiFei_m30_04 Paramters:Str FinishCallbackBlock:^(NSString *result)
                 {
                     if (result.length<=0)
                     {
                         UIAlertView * aler = [[UIAlertView alloc] initWithTitle:@"更新数据失败" message:@"网络信号不佳，请选择好的网络" delegate:self cancelButtonTitle:nil otherButtonTitles:@"确定", nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        if ([tableView isEqual:tableview_lishizhangdan])
        {
            ...
            label3.textColor=[UIColor colorWithRed:72/255.0 green:185/255.0 blue:215/255.0 alpha:1];            label3.font=[UIFont systemFontOfSize:12];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if ([tableView isEqual:tableview_lishizhangdan])
    {
        ...
        WoDeNuanQiFei_YiJiaoViewController *xiangqing=[[WoDeNuanQiFei_YiJiaoViewController alloc]init];
    ...
    else
    {
        ...
        WoDeNuanQiFei_WeiJiaoViewController *xiangqing=[[WoDeNuanQiFei_WeiJiaoViewController alloc]init];
        [self presentViewController:xiangqing animated:NO completion:nil];
