//
//  WoDeShuiFei_WeiJiaoViewController.m
//  ZHSQ
//
...
NSString *string_Ip;
@interface WoDeShuiFei_WeiJiaoViewController ()

@end

@implementation WoDeShuiFei_WeiJiaoViewController
@synthesize label_danbeibianhao,label_danjia,label_jianzhumianji,label_kehudizhi,label_kehuxingming,label_shoufeidanwei,label_wuyefei,label_xufeiqijian,label_yingjiaojine,label_youhuijine,label_bencishuibiaoshu,label_shangcishuibiaoshu;
...
- (void)viewDidLoad
{
    @try
    {
        ...
        label_jianzhumianji.text=[WYF_Dictionary objectForKey:@"property_id"];
        label_shangcishuibiaoshu.text=[WYF_Dictionary objectForKey:@"water_num_start"];
        label_bencishuibiaoshu.text=[WYF_Dictionary objectForKey:@"water_num_end"];
        label_danjia.text=[WYF_Dictionary objectForKey:@"price"];
        label_xufeiqijian.text=[NSString stringWithFormat:@"%@", [WYF_Dictionary objectForKey:@"peroid_end"]];
        ...
        _check1.frame = CGRectMake(20, 375, 60, 40);
        ...
        label=[[UILabel alloc]initWithFrame:CGRectMake(60, 375, 200, 40)];
        label.text=@"《支付服务协议》";
