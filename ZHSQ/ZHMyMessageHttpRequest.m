...
@interface ZHMyMessageHttpRequest()
{
...
@implementation ZHMyMessageHttpRequest
//联网失败
...
-(void)requestFinished:(ASIHTTPRequest *)request
{
    ...
    if(!error)
    {
        ...
        if ([self.urlStr_ isEqualToString:MyMessage_21_02]) {
            self.errorCode = 1;
        }else if ([self.urlStr_ isEqualToString:MyMessage_21_03]){
            self.errorCode = 2;
        }
    }
    else
